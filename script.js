...
const MENU = [
  ...
  { id:'c3', name:'Chocolate Lava Cake', category:'cakes', price:150, icon:'🍮',
    desc:'Warm, with a molten centre. Best eaten the moment it arrives.' },
  { id:'c4', name:'Chocolate Truffle Pastry', category:'cakes', price:250, icon:'🍰',
    desc:'Layered truffle cream over soft chocolate sponge.' },

  // Cold & Frozen
  { id:'f1', name:'Chocolate Ice Cream Cone', category:'cold', price:100, icon:'🍦',
    desc:'A classic cone, made properly.' },
  { id:'f2', name:'Belgian Chocolate Ice Cream Scoop', category:'cold', price:90, icon:'🍨',
    desc:'One generous scoop of Belgian chocolate.' },
  { id:'f3', name:'Cookie & Ice Cream Sandwich', category:'cold', price:115, icon:'🍪',
    desc:'A scoop pressed between two warm chocolate cookies.' },

  // Shakes & Drinks
  { id:'s1', name:'Nutella Thick Shake', category:'shakes', price:240, icon:'🥤',
    desc:'Thick, cold, and properly Nutella-forward.' },
  { id:'s2', name:'Chocolate Thick Shake', category:'shakes', price:220, icon:'🥤',
    desc:'Our classic shake, no shortcuts.' },
  { id:'s3', name:'Belgian Chocolate Milkshake', category:'shakes', price:180, icon:'🥤',
    desc:'Made with real Belgian chocolate.' },
  { id:'s4', name:'Cocoa Boba Milk Tea', category:'shakes', price:280, icon:'🧋',
    desc:'Milk tea with a cocoa base and chewy boba pearls.' },
  { id:'s5', name:'Classic Hot Chocolate', category:'shakes', price:200, icon:'☕',
    desc:'Rich, warm, and unapologetically simple.' },

  // Classics & Trending
  { id:'t1', name:'Chocolate Cheesecake', category:'classics', price:300, icon:'🍰',
    desc:'Dense and creamy, with a chocolate biscuit base.' },
  { id:'t2', name:'Tiramisu', category:'classics', price:350, icon:'🍮',
    desc:'Coffee-soaked layers with a cocoa dusted top.' },
  { id:'t3', name:'Dubai Chocolate Bar', category:'classics', price:350, icon:'🍫',
    desc:'Pistachio and knafeh filling wrapped in chocolate, the viral favourite.' },
  { id:'t4', name:'Dubai Chocolate Tart', category:'classics', price:280, icon:'🥧',
    desc:'The same pistachio-knafeh filling, in tart form.' },
  { id:'t5', name:'Chocolate Covered Strawberries', category:'classics', price:400, icon:'🍓',
    desc:'200g of fresh strawberries, hand-dipped in chocolate.' },
  { id:'t6', name:"S'mores Brownie", category:'classics', price:280, icon:'🍫',
    desc:'Toasted marshmallow and graham crumble over a fudgy brownie.' },
  { id:'t7', name:'Chocolate Stuffed Cookie', category:'classics', price:200, icon:'🍪',
    desc:'Two to three cookies, stuffed with a molten chocolate centre.' },
  { id:'t8', name:'Belgian Chocolate Bar', category:'classics', price:200, icon:'🍫',
